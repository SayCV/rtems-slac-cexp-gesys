#
# TILLAC_CVSTAG([$Name: cexp-gesys-snapshot-20110927 $], [pattern])
#
# Strip $Name: cexp-gesys-snapshot-20110927 $ from first argument extracting
...
#
# AC_INIT(package, TILLAC_CVSTAG([$Name: cexp-gesys-snapshot-20110927 $]))
#
...
# and using the macro:
#
# AC_INIT(package, TILLAC_CVSTAG([$Name: cexp-gesys-snapshot-20110927 $],'Release_'))
#
