/* $Id: ldep.c,v 1.40 2009/04/08 18:23:56 strauman Exp $ */
...
const char *strip = strrchr(nm,'/');
	...
	fprintf(stderr,"(This is ldep $Revision: 1.40 $ by Till Straumann <strauman@slac.stanford.edu>)\n\n");
	...
	while ( (ch=getopt(argc, argv, "vOC:FL:A:qhifsdmlux:o:e:U")) >= 0 ) {
		switch (ch) { 
			...
			case 'v':
				...
				printf("$Id: ldep.c,v 1.40 2009/04/08 18:23:56 strauman Exp $\n");
				exit(0);
